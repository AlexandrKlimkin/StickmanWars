...
public class JoystickAimProvider : IAimProvider {
    ...
    public JoystickAimProvider(Transform handTransform, MovementController movementController, PlayerActions playerActions) {
